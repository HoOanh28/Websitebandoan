...
public partial class admin_page_module_function_module_QuanLySanPham_admin_QuanLyNhomSanPham : System.Web.UI.Page
{
    ...
    protected void btnChiTiet_Click(object sender, EventArgs e)
    {
        ...
        if (getData.FirstOrDefault().pr_status == "Còn")
            rdCon.Checked = true;
        else
            rdHet.Checked = true;
        //txtTinhTrang.Text = getData.FirstOrDefault().pr_status;
    ...
    protected void btnLuu_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (rdCon.Checked)
                update.pr_status = "Còn";
            else update.pr_status = "Hết";
            //update.pr_status = txtTinhTrang.Text;
